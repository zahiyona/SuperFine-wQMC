...
class QMCAdapter(object):
    ...
    def __init__(self, quartetTrees):
        ...
        self._maxcut_path = 'wQMC/find-cut'
        self._quartets_path = 'wQMC/quartets.wqrt'
        self._output_maxcut_path = 'wQMC/wQMC.tre'
    ...
    def get_tree(self):
        ...
        command = "{} qrtt={} otre={} > {}".format(
            self._maxcut_path, self._quartets_path, self._output_maxcut_path, 'wQMC/find-cut.log')
        os.system(command)
        with open(self._output_maxcut_path, 'r') as fh:
            output = fh.read()
...
class MRPAdapter(object):
    ...
    def get_tree(self):
        ...
        pipe = Popen("paup/paup -n %s" % prefix, shell = True, stdout = PIPE, stderr = PIPE)
